...
| 選擇性安裝 | [LibreOffice](https://www.libreoffice.org/download/)（免費）——用於排版預覽與匯入的視覺辨識；沒裝也能用，相關功能會自動改用簡化模式 |
...
**Q：預覽顯示不了排版？**
真排版預覽需要 LibreOffice，裝好後重試即可（免費，見系統需求）。沒裝的話會改用結構化對照，一樣看得到每一格要填什麼。
